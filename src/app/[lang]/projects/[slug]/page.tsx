...
export default async function ProjectSlugPage({ params }: { params: Promise<{ lang: string; slug: string }> }) {
  ...
  return (
    <article className="min-h-screen bg-zinc-50 px-4 py-12 sm:px-6 lg:px-8 dark:bg-zinc-900" data-project-page>
        ...
        <header className="mb-8">
          <div className="mb-4 flex flex-wrap items-center gap-3">
            ...
            {project.year && (
              <span
                className={cn(
                  "rounded-full bg-zinc-200 px-3 py-1 text-sm text-zinc-700",
          ...
          <h1 className="mb-4 text-4xl font-bold text-zinc-900 md:text-5xl dark:text-zinc-100" data-project-page-title>
            {title}
          </h1>
          <p className="mb-6 text-xl text-zinc-600 dark:text-zinc-400" data-project-page-description>
            {description}
          </p>
