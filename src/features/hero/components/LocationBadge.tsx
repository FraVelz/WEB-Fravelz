  ...
  return (
    <div
      className={cn(
        ...
        "text-sm font-medium text-cyan-800 shadow-md ring-1 shadow-zinc-900/15 ring-zinc-900/[0.04] transition-all",
        "hover:border-cyan-600 hover:shadow-lg hover:shadow-cyan-500/15",
        "dark:border-cyan-500/40 dark:bg-zinc-900 dark:text-cyan-300 dark:shadow-lg",
    ...
    >
      <svg
        className="size-4 text-cyan-700 dark:text-cyan-400"
        fill="currentColor"
        viewBox="0 0 384 512"
        aria-hidden="true"
      >
