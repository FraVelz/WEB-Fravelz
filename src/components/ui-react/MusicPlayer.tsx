...
export default function MusicPlayer({ isOpen, onClose, className = "" }: MusicPlayerProps) {
  ...
  const modalContent = (
    <div
      className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-3 sm:p-4 md:p-6"
      onClick={onClose}
    >
      <div
      ...
      >
        <div className="sticky top-0 bg-gradient-to-r from-cyan-900/90 via-gray-900/70 to-purple-900/90 border-b border-cyan-500/40 px-4 sm:px-6 md:px-8 py-4 sm:py-5 md:py-6 flex items-center justify-between gap-3 sm:gap-4 backdrop-blur-sm shrink-0">
          ...
          <div className="flex flex-col items-center gap-4 sm:gap-5 md:gap-6">
            <select
              ...
              className="
                ...
                bg-gray-800 dark:bg-gray-800 text-cyan-200 dark:text-cyan-200 text-sm sm:text-base
                border-2 border-cyan-500/50 dark:border-cyan-500/30
                hover:border-cyan-400/80 dark:hover:border-cyan-400/60
