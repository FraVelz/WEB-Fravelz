            ...
            >
              ...
              {showInfo && (
                <div className={`
                  ...
                  from-cyan-50/98 via-blue-50/98 to-cyan-50/98
                  border-2 border-cyan-300/50 dark:border-gray-700/60
                  backdrop-blur-sm
                  rounded-b-2xl
                  p-3 sm:p-4
                ...
                `}>
                  <div className="space-y-2 text-xs sm:text-sm">
                    <div className="flex items-center justify-between">
                      <span className="font-semibold text-slate-700 dark:text-gray-400">
